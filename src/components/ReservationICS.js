...
export default function ReservationICS({ reservation }) {
  ...
  const getEvent = () => (reservation.catalogDuration === 24 ? eventAllDay : event);
  ...
  return (
    <>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
        ...
        <ICalendarLink filename={filename} event={event} rawContent={rawContent} style={{ textDecoration: "none", color: "inherit" }}>
